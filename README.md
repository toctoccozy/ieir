...
・検索ボックスは、５桁の商品番号、８ケタの商品番号、１１桁の申込み番号でも検索できるようになるか確認
・スライダーの大きさを変更
...
？ムーミン一覧や女性ジュエリー一覧の表示や並び替えはどうなっているか。できればスポーツなどでプロパー商品を出したい。

■カテゴリ　ー　コレクション
・トップの画像は差し替え
・ピックアップ→新着商品として、created_atで自動的に表示する。管理画面での変更は行わない。

■カテゴリ　ー　コレクション＞女性ジュエリー系
・女性ジュエリー色
・画像はまだ
・ページネーションあり
・他のコレクションも同様
...
・管理画面からフリーページで手動更新
・従来のプレミコトップのカードがない商品(スポーツ系)も一覧に加えるため、スクウェア画像にする
